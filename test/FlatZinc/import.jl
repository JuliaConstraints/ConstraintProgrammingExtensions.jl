@testset "Reading" begin
    ...
    @testset "Constraint section" begin
        ...
        @testset "Constraint entry" begin
            ...
            @test m.constraint_info[nc].f.terms[1].variable == x3
            @test m.constraint_info[nc].f.terms[2].coefficient === -1
            @test m.constraint_info[nc].f.terms[2].variable == x4
            ...
            @test m.constraint_info[nc].f.terms[1].coefficient === 1
            @test m.constraint_info[nc].f.terms[1].variable == x4
            ...
            @test m.constraint_info[nc].f.terms[1].variable == x1
            @test m.constraint_info[nc].f.terms[2].coefficient === 3
            @test m.constraint_info[nc].f.terms[2].variable == x2
            ...
            @test m.constraint_info[nc].f.terms[3].variable == x3
            @test m.constraint_info[nc].s == MOI.EqualTo(0)
            ...
            @test m.constraint_info[nc].f.terms[1].variable == x1
            @test m.constraint_info[nc].f.terms[2].coefficient === -1
            @test m.constraint_info[nc].f.terms[2].variable == x3
            @test m.constraint_info[nc].s == MOI.EqualTo(0)
            ...
            @test m.constraint_info[nc].f.terms[1].variable == x5
            @test m.constraint_info[nc].f.terms[2].coefficient === -1.0
            @test m.constraint_info[nc].f.terms[2].variable == x6
            ...
            @test m.constraint_info[nc].f.terms[1].variable == x3
            @test m.constraint_info[nc].f.terms[2].coefficient === -1.0
            @test m.constraint_info[nc].f.terms[2].variable == x5
            @test m.constraint_info[nc].s == MOI.EqualTo(0.0)
        end
    end
