@testset "GlobalCardinality2Count: $(fct_type), $(array_size) items, $(sought_size) sought items, $(T)" for fct_type in ["vector of variables"], array_size in [3], sought_size in [2], T in [Int]
