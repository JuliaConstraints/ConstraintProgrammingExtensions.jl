...
function MOIBC.bridge_constraint(
    ...
    vars_gt_bin = Matrix{MOI.ConstraintIndex{MOI.VariableIndex, MOI.ZeroOne}}(undef, s.column_dim - 1, s.row_dim)
    ...
    cons_indic_gt = Matrix{MOI.ConstraintIndex{MOI.VectorAffineFunction{T}, MOI.Indicator{MOI.ACTIVATE_ON_ONE, MOI.GreaterThan{T}}}}(undef, s.column_dim - 1, s.row_dim)
