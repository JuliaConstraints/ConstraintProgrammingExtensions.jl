...
function MOIB.added_constraint_types(::Type{ArgumentMinimumAmong2MILPBridge{T}}) where {T} # Bool and Real
    return [
...
function MOIB.added_constraint_types(::Type{ArgumentMinimumAmong2MILPBridge{T}}) where {T <: Integer}
    return [
        (MOI.SingleVariable, MOI.ZeroOne),
...
function MOIBC.concrete_bridge_type(
    ...
    return ArgumentMinimumAmong2MILPBridge{T}
end
