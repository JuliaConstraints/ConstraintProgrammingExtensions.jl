...
function element_scalaraffinefunction_test(
    ...
    c2 = MOI.add_constraint(model, MOIU.vectorize(MOI.VariableIndex.([x1, x2])), CP.Element([6, 5, 4]))
...
const elementtests = Dict(
    "element_singlevariable" => element_singlevariable_test,
